...
This code is to normalized holidays with the last three days prices
There is ability to combine this method by GAT Networks
...
class Forex_train_Dataset(Dataset):
    ...
    def __init__(self, csv_file, transform=None, seq_lenght = 5, train_size_ratio=0.8, notmalized_days_lenght:int=3) -> None:
        """
        Args:
        ...
        # self.normalized_days_lenght = normalized_days_lenght
